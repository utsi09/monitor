...
class GpsChecker : public BT::RosTopicSubNode<sensor_msgs::msg::NavSatFix>
{
public:
    ...
    BT::NodeStatus onTick(const std::shared_ptr<sensor_msgs::msg::NavSatFix>& last_msg) override
    {
        ...
        cout <<"gps 타임아웃 :" << timeout*1000<<" ms" << endl;
        return BT::NodeStatus::SUCCESS;
    }
private:
    rclcpp::Time last_time_;
    std::shared_ptr<sensor_msgs::msg::NavSatFix> prev_msg_;
};